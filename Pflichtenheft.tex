...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=\textwidth, keepaspectratio]{gui_conzept_start_screen.png}}
    % \caption{Startscreen}
\end{figure}

\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=\textwidth, keepaspectratio]{gui_conzept_game_screen.png}}
    % \caption{Gamescreen}
\end{figure}
